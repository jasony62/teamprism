describe("#apis", () => {
    describe("#matter", () => {
        describe("#article", () => {
            describe("#main.js", () => {
                const CtrlClass = require('../../../../../controllers/ue/matter/article/main')
                test("tmsBeforeEach()", () => {
                ...
                test("get()", () => {
                    ...
                    ctrl.model = jest.fn().mockReturnValue({ byId: mockById, fields_ue: ['id'], byMatter: mockeChannnelByMatter })
