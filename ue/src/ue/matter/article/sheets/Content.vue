<template>
  <div class="content">
    ...
    <tms-flex class="channels" v-if="matter.channels&&matter.channels.length">
      <van-tag
        plain
        type="primary"
...
export default {
  ...
  methods: {
    gotoChannel(channel) {
      location.href = `/ue/matter/channel/${this.matter.site.id}/${channel.id}/content`
    }
  }
}
</script>
